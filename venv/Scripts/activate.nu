...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Projects\FullStack\build-your-enterprise\erp-backend\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Projects\FullStack\build-your-enterprise\erp-backend\venv\Scripts\deactivate.nu'
